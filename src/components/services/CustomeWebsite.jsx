        ...
        <section className={`${layout.section} py-12 bg-primary`}>
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className={`${styles.paragraph} text-white text-center`}>
              یک وب‌سایت سفارشی می‌تواند برند شما را به بهترین نحو ممکن نمایش
              دهد و به شما این امکان را بدهد تا به راحتی با مشتریان خود در
              ارتباط باشید. با داشتن یک وب‌سایت سفارشی، شما می‌توانید تجربه‌ای
              منحصر به فرد برای کاربران خود ایجاد کنید و در دنیای دیجیتال متمایز
              باشید.
            </p>
          </div>
        </section>
